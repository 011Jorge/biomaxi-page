...
import Fish01 from "../../images/saltwater/saltwater-fish-two.jpg";
...
function Elastic() {
  return (
    <Container>
      <h1>E MUITO MAIS...</h1>
      <Carousel className="top" itemsToScroll={3} itemsToShow={3}>
        <div>
          <img src={Banner02} alt="" style={{ borderRadius: 15 }} />
        </div>
        <div>
          <img src={Fish01} alt="" style={{ height: 250 }} />
        </div>
        <div>
          <img
